...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-light fixed-top" style={{ backgroundColor: "rgb(104, 171, 181)" }}>
        <Link
          to="/"
          className="navbar-brand"
          style={{ textDecoration: "underline solid red", fontSize: "x-large", width: "30%", marginLeft: "10px" }}
        >
        ...
        <div className="search-bar collapse navbar-collapse" id="navbarSupportedContent">
